...
module = ModuleEb(name=' git',version='2.28.0',tag="GCCcore-10.2.0-nodocs ",repo_name='FuYun',install_args=['-r', '--minimal-toolchains','--rebuild'] ,repo_tag='FY', path=configure_path)
# CMake-3.16.5-GCCcore-9.3.0.eb
# Vim-8.1.1209-GCCcore-8.2.0-Python-3.7.2
# listresult=module.list_avail_pa()
...
# # print('the list module result is %s' % installresult)
# print(installresult)
# print(type(installresult))
# print(installresult)
